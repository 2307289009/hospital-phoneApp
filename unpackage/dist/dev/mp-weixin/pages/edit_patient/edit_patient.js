  ...
  setup(__props) {
    ...
    const submit = () => {
      upRef.value.validate().then(async (vali) => {
        ...
        let res = await api_index.visitEditApi(userInfo);
        if (res && res.code == 200) {
    ...
    return (_ctx, _cache) => {
      return {
        ...
        t: common_vendor.p({
          type: "primary",
          text: "确定",
          customStyle: "margin-top: 50px;background:#f39c12;border:none;"
        }),
        v: common_vendor.sr(upRef, "4028885f-0", {
          "k": "upRef"
        }),
        w: common_vendor.p({
          model: userInfo,
        ...
        x: common_vendor.sr(datetimePicker, "4028885f-14", {
          "k": "datetimePicker"
        }),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "E:/System/phone/pages/edit_patient/edit_patient.vue"]]);
